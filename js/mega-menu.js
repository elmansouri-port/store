(function () {
  ...
  var productsItems = [
    makeItem('/products/webinar', 'video-camera', 'Rainbow Webinar', 'Live and on-demand webinars with built-in engagement tools.'),
    makeItem('/products/collaboration', 'chat', 'Rainbow Collaboration', 'Team messaging, channels, and file sharing in one place.'),
    makeItem('/products/smart-hotel', 'calendar', 'Rainbow Smart Hotel', 'Smart room booking and calendar management for hotels.'),
    makeItem('/products/analytics', 'chart-bar', 'Rainbow Analytics', 'Real-time reporting and insights on your communication data.'),
    makeItem('/products/voice', 'phone', 'Rainbow Voice', 'Cloud telephony with HD voice, IVR, and call routing.'),
    makeItem('/products/security', 'lock-closed', 'Rainbow Security', 'Enterprise-grade encryption and compliance controls.')
  ].join('');
    ...
    '<div class="mega-menu" role="menu">',
      '<div class="mega-menu-inner">',
        '<div class="mega-menu-main">',
          ...
          '<a href="/products" class="mega-menu-see-all">See all products <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
        '</div>',
  ...
  var productsMobileItems = [
    makeMobileItem('/products/webinar', 'video-camera', 'Rainbow Webinar', 'Live and on-demand webinars.'),
    makeMobileItem('/products/collaboration', 'chat', 'Rainbow Collaboration', 'Team messaging and channels.'),
    makeMobileItem('/products/smart-hotel', 'calendar', 'Rainbow Smart Hotel', 'Smart room booking.'),
    makeMobileItem('/products/analytics', 'chart-bar', 'Rainbow Analytics', 'Real-time reporting.'),
    makeMobileItem('/products/voice', 'phone', 'Rainbow Voice', 'Cloud telephony.'),
    makeMobileItem('/products/security', 'lock-closed', 'Rainbow Security', 'Enterprise compliance.')
  ].join('');
  ...
  var productsMobileHTML = [
    '<div class="mega-menu-mobile-content">',
      '<div class="mega-menu-mobile-section">',
        ...
        productsMobileItems,
        '<a href="/products" class="mega-menu-mobile-see-all">See all products <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
      '</div>',
      '<div class="mega-menu-mobile-section">',
