...
app.get('/tarif1', (req, res) => sendPage(req, res, path.join(__dirname, 'pages', 'tarif1.html')));
app.get('/tarif2', (req, res) => sendPage(req, res, path.join(__dirname, 'pages', 'tarif2.html')));
app.get('/tarif3', (req, res) => sendPage(req, res, path.join(__dirname, 'pages', 'tarif3.html')));
