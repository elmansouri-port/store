(function () {
  ...
  var productsItems = [
    makeItem('/store/products/webinar', 'video-camera', 'Rainbow Webinar', 'Live and on-demand webinars with built-in engagement tools.'),
    makeItem('/store/products/collaboration', 'chat', 'Rainbow Collaboration', 'Team messaging, channels, and file sharing in one place.'),
    makeItem('/store/products/smart-hotel', 'calendar', 'Rainbow Smart Hotel', 'Smart room booking and calendar management for hotels.'),
    makeItem('/store/products/analytics', 'chart-bar', 'Rainbow Analytics', 'Real-time reporting and insights on your communication data.'),
    makeItem('/store/products/voice', 'phone', 'Rainbow Voice', 'Cloud telephony with HD voice, IVR, and call routing.'),
    makeItem('/store/products/security', 'lock-closed', 'Rainbow Security', 'Enterprise-grade encryption and compliance controls.')
  ].join('');
    ...
    '<div class="mega-menu" role="menu">',
      '<div class="mega-menu-inner">',
        '<div class="mega-menu-main">',
          '<p class="mega-menu-section-title">What we offer</p>',
          '<div class="mega-menu-grid">' + productsItems + '</div>',
          '<a href="/store/products" class="mega-menu-see-all">See all products <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
        '</div>',
        '<div class="mega-menu-side">',
          '<p class="mega-menu-section-title">Featured</p>',
          '<a href="/store/products/webinar" class="mega-menu-showcase">',
            ...
            '<div class="mega-menu-showcase-body">',
              ...
              '<p class="mega-menu-showcase-desc">Engage your audience with interactive live and on-demand webinars.</p>',
  ...
  var productsMobileItems = [
    makeMobileItem('/store/products/webinar', 'video-camera', 'Rainbow Webinar', 'Live and on-demand webinars.'),
    makeMobileItem('/store/products/collaboration', 'chat', 'Rainbow Collaboration', 'Team messaging and channels.'),
    makeMobileItem('/store/products/smart-hotel', 'calendar', 'Rainbow Smart Hotel', 'Smart room booking.'),
    makeMobileItem('/store/products/analytics', 'chart-bar', 'Rainbow Analytics', 'Real-time reporting.'),
    makeMobileItem('/store/products/voice', 'phone', 'Rainbow Voice', 'Cloud telephony.'),
    makeMobileItem('/store/products/security', 'lock-closed', 'Rainbow Security', 'Enterprise compliance.')
  ].join('');

  var productsMobileHTML = [
    '<div class="mega-menu-mobile-content">',
      '<div class="mega-menu-mobile-section">',
        '<p class="mega-menu-mobile-section-title">What we offer</p>',
        productsMobileItems,
        '<a href="/store/products" class="mega-menu-mobile-see-all">See all products <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
      '</div>',
      '<div class="mega-menu-mobile-section">',
        '<p class="mega-menu-mobile-section-title">Featured</p>',
        '<a href="/store/products/webinar" class="mega-menu-mobile-item">',
          '<span class="mega-menu-mobile-item-icon">' + svgIcon('video-camera') + '</span>',
          '<span class="mega-menu-mobile-item-text"><p class="mega-menu-mobile-item-title">Rainbow Webinar</p><p class="mega-menu-mobile-item-desc">Nouveau — Interactive live and on-demand webinars.</p></span>',
        '</a>',
      '</div>',
    ...
    '<div class="mega-menu mega-menu-tarifs" role="menu">',
      '<div class="mega-menu-inner">',
        '<div class="mega-menu-main">',
          ...
          '<a href="/store/tarifs" class="mega-menu-see-all">Voir tous les plans <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
        '</div>',
      '</div>',
      '<div class="mega-menu-footer">',
