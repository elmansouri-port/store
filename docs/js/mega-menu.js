(function () {
  ...
  var productsItems = [
    ...
    makeItem('/store/products/security', 'lock-closed', 'Rainbow Security', 'Chiffrement de niveau entreprise et contrôles de conformité.')
  ].join('');
    ...
    '<div class="mega-menu" role="menu">',
      '<div class="mega-menu-inner">',
        '<div class="mega-menu-main">',
          ...
          '<a href="/store/products" class="mega-menu-see-all">Voir tous les produits <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
        '</div>',
  ...
  var productsMobileItems = [
    ...
    makeMobileItem('/store/products/security', 'lock-closed', 'Rainbow Security', 'Conformité entreprise.')
  ].join('');
  ...
  var productsMobileHTML = [
    '<div class="mega-menu-mobile-content">',
      '<div class="mega-menu-mobile-section">',
        ...
        productsMobileItems,
        '<a href="/store/products" class="mega-menu-mobile-see-all">Voir tous les produits <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg></a>',
      '</div>',
      '<div class="mega-menu-mobile-section">',
      ...
      '<div class="mega-menu-mobile-footer">',
        '<a href="/store/Démo" class="mega-menu-btn mega-menu-btn-secondary" style="justify-content:center;">Réserver une démo</a>',
  ...
  var ressourcesMobileHTML = [
    '<div class="mega-menu-mobile-content">',
      ...
      '</div>',
      '<div class="mega-menu-mobile-footer">',
        '<a href="/store/blog" class="mega-menu-btn mega-menu-btn-secondary" style="justify-content:center;">Visiter notre blog</a>',
        '<a href="/store/support" class="mega-menu-btn mega-menu-btn-primary" style="justify-content:center;">Obtenir de l\'aide</a>',
      '</div>',
    '</div>'
  ].join('');
